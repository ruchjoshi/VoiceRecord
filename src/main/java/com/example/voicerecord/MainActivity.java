...
public class MainActivity extends AppCompatActivity {
    ...
    public static String fileName = "AudioRecording.3gp";
    String fileLocation = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + fileName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStart = (Button) findViewById(R.id.playButton);
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStopPlayingRecording = (Button)findViewById(R.id.pauseButton);
